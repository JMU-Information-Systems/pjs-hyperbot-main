...
def a_attach_browser(xaml): #auf bereits geöffnetes Fenster zurückspringen, wenn User bspw. von Browser zu Excel und dann wieder zum browser wechselt
    xaml.write("    <ui:BrowserScope BrowserType=\"Chrome\" DisplayName=\"Attach Browser\" Selector=\"&lt;html app='chrome.exe' /&gt;\">")
