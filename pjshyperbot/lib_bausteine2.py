def a_chrome_v202240 (xaml, url, id): #chrome öffnen, Kopf
    xaml.write("    <ui:OpenBrowser AutomaticallyDownloadWebDriver=\"True\" BrowserType=\"Chrome\" CommunicationMethod=\"WebDriver\" DisplayName=\"Open Browser Chrome\" Url=\""+url+"\">")
...
def a_click_left_browser_schaltfläche (xaml,application_name,url, id):
    xaml.write("            <ui:Click AlterIfDisabled=\"{x:Null}\" DelayBefore=\"{x:Null}\" DelayMS=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SimulateClick=\"{x:Null}\" ClickType=\"CLICK_SINGLE\" DisplayName=\"Click\" KeyModifiers=\"None\" MouseButton=\"BTN_LEFT\">")
    ...
    xaml.write("                <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl id='"+id+"\'/&gt;\" TimeoutMS=\"3000\">")
...
def a_click_left_browser_schaltfläche_var_2 (xaml,application_name,url, aaname):
    ...
    xaml.write("              </ui:Click.CursorPosition>")
    xaml.write("              <ui:Click.Target>")
    xaml.write("                <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl tag=\'BUTTON\' type=\'button\' aaname=\'"+aaname+"\'/&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                  <ui:Target.TimeoutMS>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("                  </ui:Target.TimeoutMS>")
    xaml.write("                  <ui:Target.WaitForReady>")
...
def a_click_left_browser_schaltfläche_var_3 (xaml,application_name,url, aaname):
    ...
    xaml.write("              </ui:Click.CursorPosition>")
    xaml.write("              <ui:Click.Target>")
    xaml.write("                <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl tag=\'BUTTON\' type=\'submit\' aaname=\'"+aaname+"\'/&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                  <ui:Target.TimeoutMS>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("                  </ui:Target.TimeoutMS>")
    xaml.write("                  <ui:Target.WaitForReady>")
...
def a_click_left_browser_schaltfläche_var_4 (xaml,application_name,url, aaname):
    ...
    xaml.write("              </ui:Click.CursorPosition>")
    xaml.write("              <ui:Click.Target>")
    xaml.write("                <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl tag=\'A\' aaname=\'"+aaname+"\'/&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                  <ui:Target.TimeoutMS>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("                  </ui:Target.TimeoutMS>")
    xaml.write("                  <ui:Target.WaitForReady>")
...
def a_click_left_browser_schaltfläche_var_5 (xaml,application_name,url, aaname):
    ...
    xaml.write("              </ui:Click.CursorPosition>")
    xaml.write("              <ui:Click.Target>")
    xaml.write("                <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl aaname=\'"+aaname+"\'/&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                  <ui:Target.TimeoutMS>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("                  </ui:Target.TimeoutMS>")
    xaml.write("                  <ui:Target.WaitForReady>")
...
def a_click_left_browser_schaltfläche_var_6 (xaml,application_name,url, aaname):
    ...
    xaml.write("              </ui:Click.CursorPosition>")
    xaml.write("              <ui:Click.Target>")
    xaml.write("                <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl tag=\'SPAN\' aaname=\'"+aaname+"\'/&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                  <ui:Target.TimeoutMS>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("                  </ui:Target.TimeoutMS>")
    xaml.write("                  <ui:Target.WaitForReady>")
...
def a_click_right_browser_schaltfläche (xaml,application_name,url, id):
    xaml.write("            <ui:Click AlterIfDisabled=\"{x:Null}\" DelayBefore=\"{x:Null}\" DelayMS=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SimulateClick=\"{x:Null}\" ClickType=\"CLICK_SINGLE\" DisplayName=\"Click\" KeyModifiers=\"None\" MouseButton=\"BTN_RIGHT\">")
    xaml.write("              <ui:Click.CursorPosition>")
    xaml.write("                <ui:CursorPosition Position=\"Center\">")
    xaml.write("                  <ui:CursorPosition.OffsetX>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
...
def a_click_left_browser_checkbox (xaml,application_name,url, id):
    xaml.write("            <ui:Click AlterIfDisabled=\"{x:Null}\" DelayBefore=\"{x:Null}\" DelayMS=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SimulateClick=\"{x:Null}\" ClickType=\"CLICK_SINGLE\" DisplayName=\"Click\" KeyModifiers=\"None\" MouseButton=\"BTN_RIGHT\">")
    xaml.write("              <ui:Click.CursorPosition>")
    xaml.write("                <ui:CursorPosition Position=\"Center\">")
    xaml.write("                  <ui:CursorPosition.OffsetX>")
    ...
    xaml.write("              </ui:Click.CursorPosition>")
    xaml.write("              <ui:Click.Target>")
    xaml.write("                <ui:Target Selector=\"&lt;html app=\'" + application_name + ".exe\' url=\'" + url + "\' /&gt;&lt;webctrl id=\'"+id+"\' tag=\'INPUT\' type=\'checkbox\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                  <ui:Target.TimeoutMS>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("                  </ui:Target.TimeoutMS>")
    xaml.write("                  <ui:Target.WaitForReady>")
...
def a_click_left_browser_checkbox_var2 (xaml,application_name,url, name):
    ...
    xaml.write("              </ui:Click.CursorPosition>")
    xaml.write("              <ui:Click.Target>")
    xaml.write("                <ui:Target Selector=\"&lt;html app=\'" + application_name + ".exe\' url=\'" + url + "\' /&gt;&lt;webctrl aaname=\'"+name+"\' tag=\'INPUT\' type=\'checkbox\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                  <ui:Target.TimeoutMS>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("                  </ui:Target.TimeoutMS>")
    xaml.write("                  <ui:Target.WaitForReady>")
...
def a_click_single_browser_optionsfeld (xaml,application_name,url, aaname):
    ...
    xaml.write("              </ui:Click.CursorPosition>")
    xaml.write("              <ui:Click.Target>")
    xaml.write("                <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl aaname=\'"+aaname+"\' aria-role=\'option'\'/&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                  <ui:Target.TimeoutMS>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("                  </ui:Target.TimeoutMS>")
    xaml.write("                  <ui:Target.WaitForReady>")
...
def a_click_option (xaml, application_name, name, id):
    xaml.write("            <ui:Click AlterIfDisabled=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SimulateClick=\"{x:Null}\" ClickType=\"CLICK_SINGLE\" DisplayName=\"Click\" KeyModifiers=\"None\" MouseButton=\"BTN_Left\">")
    xaml.write("              <ui:Click.CursorPosition>")
    xaml.write("                <ui:CursorPosition Position=\"Center\">")
    xaml.write("                  <ui:CursorPosition.OffsetX>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    ...
    xaml.write("              </ui:Click.CursorPosition>")
    xaml.write("              <ui:Click.Target>")
    xaml.write("                <ui:Target Selector=\"&lt; app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl aria-role=\'option\' aaname=\'"+name+"\' id=\'"+id+"\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                  <ui:Target.TimeoutMS>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("                  </ui:Target.TimeoutMS>")
    xaml.write("                  <ui:Target.WaitForReady>")
...
def a_click_kombinationsfeld (xaml, application_name, url, id):
    xaml.write("            <ui:Click AlterIfDisabled=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SimulateClick=\"{x:Null}\" ClickType=\"CLICK_SINGLE\" DisplayName=\"Click\" KeyModifiers=\"None\" MouseButton=\"BTN_Left\">")
    xaml.write("              <ui:Click.CursorPosition>")
    xaml.write("                <ui:CursorPosition Position=\"Center\">")
    xaml.write("                  <ui:CursorPosition.OffsetX>")
    ...
    xaml.write("              </ui:Click.CursorPosition>")
    xaml.write("              <ui:Click.Target>")
    xaml.write("                <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl tag='SELECT' id=\'"+id+"\'/&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                  <ui:Target.TimeoutMS>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("                  </ui:Target.TimeoutMS>")
    xaml.write("                  <ui:Target.WaitForReady>")
...
def a_click_single_in_application_element (xaml,application_name, title, id, role): #für alle Anwendungen außer Browser
    xaml.write("            <ui:Click AlterIfDisabled=\"{x:Null}\" DelayBefore=\"{x:Null}\" DelayMS=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SimulateClick=\"{x:Null}\" ClickType=\"CLICK_SINGLE\" DisplayName=\"Click\" KeyModifiers=\"None\" MouseButton=\"BTN_LEFT\">")
    xaml.write("              <ui:Click.CursorPosition>")
    xaml.write("                <ui:CursorPosition Position=\"Center\">")
    xaml.write("                  <ui:CursorPosition.OffsetX>")
    ...
    xaml.write("              </ui:Click.CursorPosition>")
    xaml.write("              <ui:Click.Target>")
    xaml.write("                <ui:Target Selector=\"&lt;wnd app=\'"+application_name+".exe\' title=\'"+title+"\' &lt;uia automationid=\'"+id+"\' role=\'Element\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                  <ui:Target.TimeoutMS>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("                  </ui:Target.TimeoutMS>")
    xaml.write("                  <ui:Target.WaitForReady>")
...
def a_click_single_in_application (xaml,application_name, title, automationid, role): #für alle Anwendungen außer Browser
    xaml.write("            <ui:Click AlterIfDisabled=\"{x:Null}\" DelayBefore=\"{x:Null}\" DelayMS=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SimulateClick=\"{x:Null}\" ClickType=\"CLICK_SINGLE\" DisplayName=\"Click\" KeyModifiers=\"None\" MouseButton=\"BTN_LEFT\">")
    xaml.write("              <ui:Click.CursorPosition>")
    xaml.write("                <ui:CursorPosition Position=\"Center\">")
    xaml.write("                  <ui:CursorPosition.OffsetX>")
    ...
    xaml.write("              </ui:Click.CursorPosition>")
    xaml.write("              <ui:Click.Target>")
    xaml.write("                <ui:Target Selector=\"&lt;wnd app=\'"+application_name+".exe\' title=\'"+title+"\' &lt;uia automationid=\'"+automationid+"\' role=\'"+role+"\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                  <ui:Target.TimeoutMS>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("                  </ui:Target.TimeoutMS>")
    xaml.write("                  <ui:Target.WaitForReady>")
...
def a_click_single_in_application_var2 (xaml,application_name, title, name): #für alle Anwendungen außer Browser
    ...
    xaml.write("              </ui:Click.CursorPosition>")
    xaml.write("              <ui:Click.Target>")
    xaml.write("                <ui:Target Selector=\"&lt;wnd app=\'"+application_name+".exe\' title=\'"+title+"\' &lt;uia name=\'"+name+"\' role=\'"+role+"\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                  <ui:Target.TimeoutMS>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("                  </ui:Target.TimeoutMS>")
    xaml.write("                  <ui:Target.WaitForReady>")
...
def a_click_right_in_application (xaml,application_name, title, automationid, role): #für alle Anwendungen außer Browser
    xaml.write("            <ui:Click AlterIfDisabled=\"{x:Null}\" DelayBefore=\"{x:Null}\" DelayMS=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SimulateClick=\"{x:Null}\" ClickType=\"CLICK_SINGLE\" DisplayName=\"Click\" KeyModifiers=\"None\" MouseButton=\"BTN_RIGHT\">")
    xaml.write("              <ui:Click.CursorPosition>")
    xaml.write("                <ui:CursorPosition Position=\"Center\">")
    xaml.write("                  <ui:CursorPosition.OffsetX>")
...
def a_click_left_in_explorer_var_2 (xaml,application_name, title, name): #für alle Anwendungen außer Browser
    ...
    xaml.write("              </ui:Click.CursorPosition>")
    xaml.write("              <ui:Click.Target>")
    xaml.write("                <ui:Target Selector=\"&lt;wnd app=\'"+application_name+".exe\' title=\'"+title+"\' &lt;uia name=\'"+name+"\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                  <ui:Target.TimeoutMS>")
    xaml.write("                    <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("                  </ui:Target.TimeoutMS>")
    xaml.write("                  <ui:Target.WaitForReady>")
...
def a_send_hotkey_strg_c_browser (xaml, application_name, url, id): #wenn keytroke strg + c ist, einfügen
    xaml.write("      <ui:SendHotkey DelayBefore=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SpecialKey=\"{x:Null}\" Activate=\"True\" ClickBeforeTyping=\"True\" DisplayName=\"Send Hotkey\" EmptyField=\"True\" Key=\"c\" KeyModifiers=\"Ctrl\">")
    xaml.write("        <ui:SendHotkey.Target>")
    xaml.write("          <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl id=\'"+id+"\' tag=\'INPUT\' type=\'text\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("            <ui:Target.TimeoutMS>")
    xaml.write("              <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("            </ui:Target.TimeoutMS>")
    xaml.write("            <ui:Target.WaitForReady>")
...
def a_send_hotkey_strg_c_browser_var2 (xaml, application_name, url, name): #wenn keytroke strg + c ist, einfügen
    xaml.write("      <ui:SendHotkey DelayBefore=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SpecialKey=\"{x:Null}\" Activate=\"True\" ClickBeforeTyping=\"True\" DisplayName=\"Send Hotkey\" EmptyField=\"True\" Key=\"c\" KeyModifiers=\"Ctrl\">")
    xaml.write("        <ui:SendHotkey.Target>")
    xaml.write("          <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl aaname=\'"+name+"\' tag=\'INPUT\' type=\'text\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("            <ui:Target.TimeoutMS>")
    xaml.write("              <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("            </ui:Target.TimeoutMS>")
    xaml.write("            <ui:Target.WaitForReady>")
...
def a_send_hotkey_strg_c_browser_var3 (xaml, application_name, url): #wenn keytroke strg + c ist, einfügen
    xaml.write("      <ui:SendHotkey DelayBefore=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SpecialKey=\"{x:Null}\" Activate=\"True\" ClickBeforeTyping=\"True\" DisplayName=\"Send Hotkey\" EmptyField=\"True\" Key=\"c\" KeyModifiers=\"Ctrl\">")
    xaml.write("        <ui:SendHotkey.Target>")
    xaml.write("          <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl tag=\'INPUT\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("            <ui:Target.TimeoutMS>")
    xaml.write("              <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("            </ui:Target.TimeoutMS>")
    xaml.write("            <ui:Target.WaitForReady>")
...
def a_send_hotkey_strg_v_browser (xaml, application_name, url, id):
    xaml.write("      <ui:SendHotkey DelayBefore=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SpecialKey=\"{x:Null}\" Activate=\"True\" ClickBeforeTyping=\"True\" DisplayName=\"Send Hotkey\" EmptyField=\"True\" Key=\"v\" KeyModifiers=\"Ctrl\">")
    xaml.write("        <ui:SendHotkey.Target>")
    xaml.write("          <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl tag='INPUT' type=\'text\' id=\'"+id+"\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("            <ui:Target.TimeoutMS>")
    xaml.write("              <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("            </ui:Target.TimeoutMS>")
    xaml.write("            <ui:Target.WaitForReady>")
...
def a_send_hotkey_strg_v_browser_var2 (xaml, application_name, url, name):
    xaml.write("      <ui:SendHotkey DelayBefore=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SpecialKey=\"{x:Null}\" Activate=\"True\" ClickBeforeTyping=\"True\" DisplayName=\"Send Hotkey\" EmptyField=\"True\" Key=\"v\" KeyModifiers=\"Ctrl\">")
    xaml.write("        <ui:SendHotkey.Target>")
    xaml.write("          <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl tag='INPUT' type=\'text\' aaname=\'"+name+"\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("            <ui:Target.TimeoutMS>")
    xaml.write("              <InArgument x:TypeArguments=\"x:Int32\" />")
    xaml.write("            </ui:Target.TimeoutMS>")
    xaml.write("            <ui:Target.WaitForReady>")
...
def a_send_hotkey_strg_v_browser_var3 (xaml, application_name, url):
    xaml.write("      <ui:SendHotkey DelayBefore=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SpecialKey=\"{x:Null}\" Activate=\"True\" ClickBeforeTyping=\"True\" DisplayName=\"Send Hotkey\" EmptyField=\"True\" Key=\"v\" KeyModifiers=\"Ctrl\">")
    xaml.write("        <ui:SendHotkey.Target>")
    xaml.write("          <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl tag='INPUT' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("            <ui:Target.TimeoutMS>")
...
def a_type_into_browser (xaml,application_name, url, id): #klappt, evtl. value noch ergänzen, d.h. Texteingabe?
    xaml.write("            <ui:TypeInto DelayBefore=\"{x:Null}\" DelayMS=\"{x:Null}\" Activate=\"True\" ClickBeforeTyping=\"True\" DisplayName=\"Type Into\" EmptyField=\"True\" Text=\"gewünschten Text eintragen\">")
...
def a_type_into_browser_var2 (xaml,application_name, url, name): #klappt, evtl. value noch ergänzen, d.h. Texteingabe?
    xaml.write("            <ui:TypeInto DelayBefore=\"{x:Null}\" DelayMS=\"{x:Null}\" Activate=\"True\" ClickBeforeTyping=\"True\" DisplayName=\"Type Into\" EmptyField=\"True\" Text=\"gewünschten Text eintragen\">")
    xaml.write("              <ui:TypeInto.Target>")
    xaml.write("               <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl aaname=\'"+name+"\' tag=\'INPUT\' type=\'text\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                </ui:Target>")
...
def a_type_into_browser_var3 (xaml,application_name, url): #klappt, evtl. value noch ergänzen, d.h. Texteingabe?
    xaml.write("            <ui:TypeInto DelayBefore=\"{x:Null}\" DelayMS=\"{x:Null}\" Activate=\"True\" ClickBeforeTyping=\"True\" DisplayName=\"Type Into\" EmptyField=\"True\" Text=\"gewünschten Text eintragen\">")
    xaml.write("              <ui:TypeInto.Target>")
    xaml.write("               <ui:Target Selector=\"&lt;html app=\'"+application_name+".exe\' url=\'"+url+"\' /&gt;&lt;webctrl tag=\'INPUT\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                </ui:Target>")
...
def a_type_into_application (xaml,application_name, title, automationid):
    xaml.write("            <ui:TypeInto DelayBefore=\"{x:Null}\" DelayMS=\"{x:Null}\" Activate=\"True\" ClickBeforeTyping=\"True\" DisplayName=\"Type Into\" EmptyField=\"True\" Text=\"gewünschten Text eintragen\">")
    xaml.write("              <ui:TypeInto.Target>")
    xaml.write("               <ui:Target Selector==\"&lt;wnd app=\'"+application_name+".exe\' title=\'"+title+"\' &lt;uia automationid=\'"+automationid+"\' role=\'Element\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                </ui:Target>")
    xaml.write("              </ui:TypeInto.Target>")
    xaml.write("            </ui:TypeInto>")
...
def a_type_into_explorer (xaml,application_name, title, id, name, role):
    xaml.write("            <ui:TypeInto DelayBefore=\"{x:Null}\" DelayMS=\"{x:Null}\" Activate=\"True\" ClickBeforeTyping=\"True\" DisplayName=\"Type Into\" EmptyField=\"True\" Text=\"gewünschten Text eintragen\">")
    xaml.write("              <ui:TypeInto.Target>")
    xaml.write("               <ui:Target Selector==\"&lt;wnd app=\'"+application_name+".exe\' title=\'"+title+"\' &lt;uia automationid=\'"+id+"\' name=\'"+name+"\' role=\'"+role+"\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("                </ui:Target>")
    xaml.write("              </ui:TypeInto.Target>")
    xaml.write("            </ui:TypeInto>")
...
def a_send_hotkey_strg_c_in_application (xaml,application_name, title, id):
    xaml.write("      <ui:SendHotkey DelayBefore=\"{x:Null}\" SendWindowMessages=\"{x:Null}\" SpecialKey=\"{x:Null}\" Activate=\"True\" ClickBeforeTyping=\"True\" DisplayName=\"Send Hotkey\" EmptyField=\"True\" Key=\"c\" KeyModifiers=\"Ctrl\">")
    xaml.write("        <ui:SendHotkey.Target>")
    xaml.write("                <ui:Target Selector=\"&lt;wnd app=\'"+application_name+".exe\' title=\'"+title+"\' &lt;uia automationid=\'"+id+"\' role=\'Element\' /&gt;\" TimeoutMS=\"3000\">")
    xaml.write("            <ui:Target.TimeoutMS>")
