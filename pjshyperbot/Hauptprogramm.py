            ...
            #Abfrage auf Aktivitäten, Mousecklicks
                ...
                if (row[column['u_type']]) == "Schaltfläche" or "Optionsfeld":
                    ...
                    if (row[column['u_eventtype']]) == "Left-Down":
                        ...
                        #try:
                        lib2_bausteine.a_click_left_browser_schaltfläche(xaml,str(row[column['a_applicationname']]),url,str(row[column['automationid']])) #url von oben, modifiziert
                        #Try Bausteine schließen
